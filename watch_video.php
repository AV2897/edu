...
<body>
   ...
   <section class="comments">
      ...
      <form action="" method="post" class="add-comment">
         ...
         <textarea name="comment_box" required placeholder="Add a comment" maxlength="1000" cols="30" rows="10"></textarea>
               ...
               <div class="box" style="<?php if ($fetch_comment['user_id'] == $user_id) {
                  ...
                  ?>
                     <form action="" method="post" class="flex-btn">
                        ...
                        <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('Want to delete Comment?');">Delete Comment</button>
                     </form>
                  <?php
                  }
                  ?>
