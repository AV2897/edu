...
if(isset($_POST['submit'])){
   ...
   $verify_playlist = $conn->prepare("SELECT * FROM 'playlist' WHERE id = ? AND tutor_id = ? AND title = ? AND description = ?");
...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="Status" maxlength="100" required placeholder="Enter playlist title" class="box">
